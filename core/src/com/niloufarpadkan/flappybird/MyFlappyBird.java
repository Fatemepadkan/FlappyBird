    ...
    public void render() {
        ...
        if (gameState == 1 && exitConfirm != 1) {
            ...
            if (exitConfirm != 1) {
                ...
                playAgainButton.setPosition(Gdx.graphics.getWidth() / 2 - playAgainTexture.getWidth() / 2
                        , Gdx.graphics.getHeight() / 2 - playAgainTexture.getHeight() / 2 - 150);  //hikeButton is an ImageButton
        ...
        birdCircle.set(Gdx.graphics.getWidth() / 2, birdY + birds[flatState].getHeight() / 2, (birds[flatState].getWidth() / 2 - 5) * scale);
